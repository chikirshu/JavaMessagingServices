package com.ck.jms.hm.eligibilitycheck.listeners;
	...
	public void onMessage(Message message) {
		...
		try (ActiveMQConnectionFactory cf = new ActiveMQConnectionFactory();
			...
			if (insuranceProvider.equals("Blue Cross Blue Shield") || insuranceProvider.equals("United Health")) {
				...
				System.out.println("Amount to be paid: "+patient.getAmtToBePaid());
				if (patient.getCopay() < 40 && patient.getAmtToBePaid() < 1000) {
